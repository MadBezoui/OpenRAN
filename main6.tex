...
model version and emits a replayable audit certificate for every
...
with model-version binding and replayable audit certificates;
...
descriptions; ``n/r'' denotes a property not reported as a design
...
\node[gate,right=of verifier] (gate)
  {Atomic version\\check and\\forwarding gate};
